# Death Stranding 2 calculateur de ressources
Un simple calculateur de ressources à emporter lorsque vous souhaitez réparer/améliorer une ou plusieurs structures

# Comment télécharger/utiliser ?
## Télécharger :
  -Il vous suffit de cliquer sur le .rar, le .exe et les fichiers nécessaires sont à l'intérieur  
...
## Utiliser :
  -Extrayez le .rar à l'emplacement de votre choix  
  -Ouvrez le dossier  
